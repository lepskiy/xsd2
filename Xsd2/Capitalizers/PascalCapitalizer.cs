...
{
    public class PascalCapitalizer : ICapitalizer
    {
        private static readonly Regex _wordRegEx = new Regex("([a-zA-Z]+)|([0-9]+)", RegexOptions.Compiled);
        ...
        /// </remarks>
        public PascalCapitalizer()
            : this(3)
        {
        }

        public PascalCapitalizer(int capitalizeAllUpperMinLength)
        {
